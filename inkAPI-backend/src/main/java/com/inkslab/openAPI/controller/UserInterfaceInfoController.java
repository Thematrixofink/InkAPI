...
import com.inkslab.openAPI.model.dto.userInterfaceInfo.UserInterfaceInfoAddRequest;
import com.inkslab.openAPI.model.dto.userInterfaceInfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<UserInterfaceInfo>> listenUserInterfaceInfoByPage(@RequestParam("current") long current,@RequestParam("pageSize") long size) {
        // 限制爬虫
